...
},{"./components/Layout":3,"./components/SignIn":5,"jquery":11,"page":12}],2:[function(require,module,exports){
'use strict';

var $ = require('jquery');

var MarvelApi = require('./util/marvel-api.js');
...
},{"./util/marvel-api.js":7,"jquery":11}],3:[function(require,module,exports){
'use strict';
...
},{"../../avengers.js":2,"./template.jade":4,"jquery":11,"page":12}],4:[function(require,module,exports){
...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (clase, text, undefined) {
buf.push("<section class=\"Layout\"><h1>Marvel Card Game</h1><section class=\"Layout-antagonist\">");
clase = "Card--antagonist"
// iterate [1,2,3,4,5]
;(function(){
  var $$obj = [1,2,3,4,5];
...
buf.push("<div" + (jade.cls(["Card "+clase], [true])) + "><div class=\"Card-container\"><h2 class=\"Card-name\">Wolverine</h2><img src=\"./img/wolverine.jpg\" alt=\"Wolverine\" class=\"Card-image\"/><div class=\"Card-description\">Wolverine es muy poderoso</div><div class=\"Card-attack\">500 puntos de ataque</div></div><div class=\"Card-backface\"></div></div>");
    }
...
// iterate ["Ricardo","Pepito"]
;(function(){
  var $$obj = ["Ricardo","Pepito"];
  if ('number' == typeof $$obj.length) {

    for (var $index = 0, $$l = $$obj.length; $index < $$l; $index++) {
      var name = $$obj[$index];

buf.push("<div class=\"Status\"><h3 class=\"Status-player\">" + (jade.escape(null == (jade_interp = name) ? "" : jade_interp)) + "</h3><p class=\"Status-points\">10000</p></div>");
    }
...
buf.push("</div><div class=\"Layout-battle\">");
clase = ""
buf.push("<div class=\"Battle\"><div class=\"Battle-antagonist\">");
// iterate [1,2,3,4,5]
;(function(){
  var $$obj = [1,2,3,4,5];
  if ('number' == typeof $$obj.length) {
...
text = "OMG El ataque es muy poderoso y le bajaste 1000 puntos"
...
buf.push("</section></section>");}.call(this,"clase" in locals_for_with?locals_for_with.clase:typeof clase!=="undefined"?clase:undefined,"text" in locals_for_with?locals_for_with.text:typeof text!=="undefined"?text:undefined,"undefined" in locals_for_with?locals_for_with.undefined:typeof undefined!=="undefined"?undefined:undefined));;return buf.join("");
};
...
},{"./template.jade":6,"jquery":11,"page":12}],6:[function(require,module,exports){
var jade = require("jade/runtime");
...
buf.push("<div class=\"Signin-container\"><label>Ingresa tu nombre</label><input id=\"firstName\" type=\"text\" name=\"firstName\" tabindex=\"1\" placeholder=\"pepito, juan, etc...\" class=\"Signin-name-input\"/><button tabindex=\"2\" class=\"Signin-button\">Comenzar</button></div>");;return buf.join("");
};
